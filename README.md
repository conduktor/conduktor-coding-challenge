...
Write a [tornadofx](https://github.com/edvin/tornadofx) application in Kotlin or a [scalafx](https://www.scalafx.org/) application in Scala, (or a web front-end but that's not how Conduktor is made yet!) where we can see records from a topic:
